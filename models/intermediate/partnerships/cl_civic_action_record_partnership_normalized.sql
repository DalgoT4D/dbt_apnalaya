...
with 
    ...
    {{ dbt_utils.deduplicate(
        relation=source('kobo_partnerships','cl_civic_action_record_partnership_new'),
        partition_by='_id',
...
SELECT 
    ...
    clca.data->>'Cluster_Name' AS cluster_name, 
    clca.data->>'Group_Name_' AS group_name, 
...
FROM deduped_cte_new as clca
)

SELECT * from civic_action_data_new
